...
dictl={'laptop':'Laptop bags','briefcase':'briefcases','trolly':'cabin bags','cabin':'cabin bags','duffle':'travel duffles','handbag':'handbags','wallet':'wallet for men','sling':'sling bags','school':'school bags','messenger':'messenger bags'}
lstu=[]
results=cur.fetchall()
ctl=['laptop','briefcase','trolly','cabin','duffle','handbag','wallet','sling','school','messenger']
kewrds={'Laptop bags':['laptop'],'briefcases':['briefcase'],'cabin bags':['trolly','cabin'],'travel duffles':['duffle'],'handbags':['handbag'],'wallet for men':['wallet'],'sling bags':['sling'],'school bags':['school']}
